...
**/profile**    authenticated user personal page

## M2. Organization
- **Users**                     /identities
- **Assignments**               /sk-penempatan
- **Companies**                 /realms
- **Division**                  /org-units
- **Position/Job Title**        /positions
...
- **Data Masking**      /settings/data-masking
- **OAuth Clients**     /clients
- **SCIM Clients**      /clients-scim

| Module | Route | Desc |
|-|-|-|
| Login | / | un-authenticated user first-page |
| Dasboard | / | authenticated user first-page |
| Profile | /profile |-|
| Users | /identities
| Assignments | /sk-penempatan
| Companies | /realms
