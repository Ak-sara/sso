...
const log = useLogger({ module: 'org:version-manager' });
...
export class VersionManager {
	...
	async createVersion(
		...
		log.info('Creating version', { versionNumber: nextVersionNumber, organizationId });
		...
		log.info('Version created', { versionId: result.insertedId.toString() });
