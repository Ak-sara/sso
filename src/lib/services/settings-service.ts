...
export const DEFAULT_SETTINGS: Omit<SystemSettings, '_id'>[] = [
	...
	{ key: 'email_service_config', value: { nodemailer: { host: '', port: 587, secure: false, user: '', password: '', fromEmail: '', fromName: '' } }, type: 'json', category: 'email', label: 'Email Service Configuration', description: 'Configuration for selected email provider', updatedAt: new Date() },
];
