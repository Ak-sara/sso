	...
	<div class="bg-white shadow-2xl rounded-2xl p-8">
		...
		{#if form?.success}
			...
			<div class="text-center">
				...
				<a class="block w-full px-4 py-3 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 transition-colors text-center"
		...
		{:else}
			...
			<form class="space-y-4" method="POST"
				...
				<button class="w-full px-4 py-3 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
